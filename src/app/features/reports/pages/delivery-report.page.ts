// src/app/features/reports/pages/delivery-report.page.ts
...
import { exportarEntregasPorColaborador } from '../pdf/delivery-report.exporter';
...
export class DeliveryReportPage {
  pageName = 'Acta de Entregas';
  pageKey = 'reports:delivery';
  ...
  cols: SmartTableColumn[] = [
    { field: 'descArea',            header: 'Área',             cellType: 'text',         minWidthPx: 220, sortable: true,  filterable: true, filterType: 'text',  filterUI: 'multiselect' },
    { field: 'descSeccion',         header: 'Sección',          cellType: 'text',         minWidthPx: 220, sortable: true,  filterable: true, filterType: 'text',  filterUI: 'multiselect' },
    { field: 'nroDoc',              header: 'Doc.',             cellType: 'text',         minWidthPx: 100, sortable: true,  filterable: true, filterType: 'text',  align: 'center' },
    { field: 'nombres',             header: 'Nombres',          cellType: 'text',         minWidthPx: 200, sortable: true,  filterable: true, filterType: 'text',  filterUI: 'multiselect' },
    ...
    { field: 'firma',               header: 'Firma',            cellType: 'imageBase64',  minWidthPx: 140, sortable: false, filterable: false },
  ];
  ...
  rows = computed(() => this.store.listaEntregas());
  ...
  onFilter(f: { dateRange?: string[] | null; docs?: string[] | null }) {
    ...
    this.store.loadEntregas({ fini, ffin, nroDoc: docs });
  }
